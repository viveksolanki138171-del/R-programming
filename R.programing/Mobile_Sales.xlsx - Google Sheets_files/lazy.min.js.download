...
isNaN(e)&&(e=0)}catch(k){e=0}try{b=parseInt;var f=a.getDisplaySettings().getPromptDelay();var g=L(f,W,2);var h=b(kh(g.getSeconds()),10);isNaN(h)&&(h=0)}catch(k){h=0}return Math.floor(Math.random()*(h-e+1))+e},Ci=function(a,b,c){var d=c.nonProd?"nonprod":"prod",e=c.language&&Eg[c.language.toLowerCase()]?Eg[c.language.toLowerCase()]:Eg[a.locale_.toLowerCase()];e=e&&e.replace("-","_");e==="fa"&&(e="en");var f=e?encodeURI(e):"en";b.enableReloadScriptWhenLanguageChanges&&!ej("https://www.gstatic.com/uservoice/surveys/resources/"+
d+"/js/survey/survey_binary__"+f+".js")&&fj();window.hatsNextGlobalObject?gj(b,c):(e=document.createElement("script"),d=S(pi,d,f),wd(e,d),e.type="text/javascript",e.onload=function(){return gj(b,c)},e.onerror=function(){b.listener&&b.listener.surveyPrompted&&b.listener.surveyPrompted(c,{reason:"Failed to load survey binary"})},e.setAttribute("data-survey-binary",""),a.nonce_&&e.setAttribute("nonce",a.nonce_),document.querySelector("[data-survey-binary]")||document.body.appendChild(e))},gj=function(a,
...
hideInlineSurveyBackground:a.hideInlineSurveyBackground,feedback1pEnabled:b.feedback1pEnabled,thirdPartyDomainSupportEnabled:b.thirdPartyDomainSupportEnabled})}},aj=function(){var a=B("help.globals.actions",top);a||(a=new Xe,Ea("help.globals.actions",a,top));return a},ej=function(a){return[].concat(la(document.getElementsByTagName("script"))).find(function(b){return b&&b.getAttribute("src")===a})},fj=function(){[].concat(la(document.getElementsByTagName("script"))).forEach(function(a){var b;if(a==
